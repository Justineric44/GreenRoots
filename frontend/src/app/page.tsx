...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-brand-bg text-brand-dark">
      <section
        className="relative isolate min-h-[680px] overflow-hidden px-4 py-24 text-brand-white sm:px-6 lg:px-8 lg:py-28"
        aria-label="Bannière principale GreenRoots"
      >
        {/*
          Image purement décorative — le contenu sémantique est dans h1 et p.
          alt="" + aria-hidden="true" → ignorée par les lecteurs d'écran.
        */}
        <Image
        ...
        {/* Overlay décoratif — masqué aux lecteurs d'écran */}
        <div
          className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/40 via-70% to-brand-dark"
          aria-hidden="true"
        />
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-center text-center pt-20">
          ...
          <p className="mt-10 max-w-2xl text-lg font-semibold leading-7 text-brand-white sm:text-2xl">
            Choisissez un arbre, contribuez à la reforestation, suivez votre
            impact&nbsp;!
          </p>
        </div>
      </section>
